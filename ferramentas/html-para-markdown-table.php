...
ns_redirect_legacy_url('/ferramentas/html-para-markdown-table');
ns_render_page_start('tool:html-para-markdown-table');
?>
<main>
  <div class="tool-page">
    <nav class="breadcrumb" aria-label="Navegação breadcrumb"><a href="<?= ns_escape(ns_href('/')) ?>">Início</a><span class="sep">›</span><a href="<?= ns_escape(ns_href('/ferramentas')) ?>">Ferramentas</a><span class="sep">›</span><span>HTML para Markdown Table</span></nav>
    <div class="tool-header"><div class="tool-page-icon" style="background:linear-gradient(135deg,#eef4ff,#dbe7ff)">🗃️</div><div><h1>HTML para Markdown Table</h1><p>Converter tabela com interface simples e resultado imediato.</p><span class="tag tag-green">Dados</span></div></div>
    <div class="tool-box">
