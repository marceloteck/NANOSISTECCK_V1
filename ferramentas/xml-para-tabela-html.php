...
ns_redirect_legacy_url('/ferramentas/xml-para-tabela-html');
ns_render_page_start('tool:xml-para-tabela-html');
?>
<main>
  <div class="tool-page">
    <nav class="breadcrumb" aria-label="Navegação breadcrumb"><a href="<?= ns_escape(ns_href('/')) ?>">Início</a><span class="sep">›</span><a href="<?= ns_escape(ns_href('/ferramentas')) ?>">Ferramentas</a><span class="sep">›</span><span>XML para Tabela HTML</span></nav>
    <div class="tool-header"><div class="tool-page-icon" style="background:linear-gradient(135deg,#eef4ff,#dbe7ff)">🗃️</div><div><h1>XML para Tabela HTML</h1><p>Tabela visual simples com interface simples e resultado imediato.</p><span class="tag tag-green">Dados</span></div></div>
    <div class="tool-box">
