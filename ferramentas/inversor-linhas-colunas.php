...
ns_redirect_legacy_url('/ferramentas/inversor-linhas-colunas');
ns_render_page_start('tool:inversor-linhas-colunas');
?>
<main>
  <div class="tool-page">
    <nav class="breadcrumb" aria-label="Navegação breadcrumb"><a href="<?= ns_escape(ns_href('/')) ?>">Início</a><span class="sep">›</span><a href="<?= ns_escape(ns_href('/ferramentas')) ?>">Ferramentas</a><span class="sep">›</span><span>Inversor de Linhas e Colunas</span></nav>
    <div class="tool-header"><div class="tool-page-icon" style="background:linear-gradient(135deg,#eef4ff,#dbe7ff)">🗃️</div><div><h1>Inversor de Linhas e Colunas</h1><p>Transpor tabela com interface simples e resultado imediato.</p><span class="tag tag-green">Dados</span></div></div>
    <div class="tool-box">
