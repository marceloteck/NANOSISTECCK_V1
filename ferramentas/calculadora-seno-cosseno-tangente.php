...
ns_redirect_legacy_url('/ferramentas/calculadora-seno-cosseno-tangente');
ns_render_page_start('tool:calculadora-seno-cosseno-tangente');
?>
<main>
  <div class="tool-page">
    <nav class="breadcrumb" aria-label="Navegação breadcrumb"><a href="<?= ns_escape(ns_href('/')) ?>">Início</a><span class="sep">›</span><a href="<?= ns_escape(ns_href('/ferramentas')) ?>">Ferramentas</a><span class="sep">›</span><span>Calculadora de Seno Cosseno Tangente</span></nav>
    <div class="tool-header"><div class="tool-page-icon" style="background:linear-gradient(135deg,#eef4ff,#dbe7ff)">🧮</div><div><h1>Calculadora de Seno Cosseno Tangente</h1><p>Calcular razões trigonométricas com interface simples e resultado imediato.</p><span class="tag tag-green">Matemática</span></div></div>
    <div class="tool-box">
