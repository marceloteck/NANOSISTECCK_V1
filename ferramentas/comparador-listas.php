...
ns_redirect_legacy_url('/ferramentas/comparador-listas');
ns_render_page_start('tool:comparador-listas');
?>
<main>
  <div class="tool-page">
    <nav class="breadcrumb" aria-label="Navegação breadcrumb"><a href="<?= ns_escape(ns_href('/')) ?>">Início</a><span class="sep">›</span><a href="<?= ns_escape(ns_href('/ferramentas')) ?>">Ferramentas</a><span class="sep">›</span><span>Comparador de Listas</span></nav>
    <div class="tool-header"><div class="tool-page-icon" style="background:linear-gradient(135deg,#eef4ff,#dbe7ff)">⚙️</div><div><h1>Comparador de Listas</h1><p>Itens em comum e exclusivos com interface simples e resultado imediato.</p><span class="tag tag-green">DevOps</span></div></div>
    <div class="tool-box">
