...
ns_redirect_legacy_url('/ferramentas/calculadora-orcamento-festa');
ns_render_page_start('tool:calculadora-orcamento-festa');
?>
<main>
  <div class="tool-page">
    <nav class="breadcrumb" aria-label="Navegação breadcrumb"><a href="<?= ns_escape(ns_href('/')) ?>">Início</a><span class="sep">›</span><a href="<?= ns_escape(ns_href('/ferramentas')) ?>">Ferramentas</a><span class="sep">›</span><span>Calculadora de Orçamento de Festa</span></nav>
    <div class="tool-header"><div class="tool-page-icon" style="background:linear-gradient(135deg,#eef4ff,#dbe7ff)">🏠</div><div><h1>Calculadora de Orçamento de Festa</h1><p>Custo por convidado com interface simples e resultado imediato.</p><span class="tag tag-green">Cotidiano</span></div></div>
    <div class="tool-box">
