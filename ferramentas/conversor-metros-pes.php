...
ns_redirect_legacy_url('/ferramentas/conversor-metros-pes');
ns_render_page_start('tool:conversor-metros-pes');
?>
<main>
  <div class="tool-page">
    <nav class="breadcrumb" aria-label="Navegação breadcrumb"><a href="<?= ns_escape(ns_href('/')) ?>">Início</a><span class="sep">›</span><a href="<?= ns_escape(ns_href('/ferramentas')) ?>">Ferramentas</a><span class="sep">›</span><span>Conversor de Metros para Pés</span></nav>
    <div class="tool-header"><div class="tool-page-icon" style="background:linear-gradient(135deg,#eef4ff,#dbe7ff)">🔄</div><div><h1>Conversor de Metros para Pés</h1><p>Medida linear com interface simples e resultado imediato.</p><span class="tag tag-green">Conversores</span></div></div>
    <div class="tool-box">
