...
ns_redirect_legacy_url('/ferramentas/conversor-json-chave-valor');
ns_render_page_start('tool:conversor-json-chave-valor');
?>
<main>
  <div class="tool-page">
    <nav class="breadcrumb" aria-label="Navegação breadcrumb"><a href="<?= ns_escape(ns_href('/')) ?>">Início</a><span class="sep">›</span><a href="<?= ns_escape(ns_href('/ferramentas')) ?>">Ferramentas</a><span class="sep">›</span><span>Conversor JSON para Chave=Valor</span></nav>
    <div class="tool-header"><div class="tool-page-icon" style="background:linear-gradient(135deg,#eef4ff,#dbe7ff)">🗃️</div><div><h1>Conversor JSON para Chave=Valor</h1><p>Converter estrutura com interface simples e resultado imediato.</p><span class="tag tag-green">Dados</span></div></div>
    <div class="tool-box">
