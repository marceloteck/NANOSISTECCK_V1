...
ns_redirect_legacy_url('/ferramentas/calculadora-ciclos-sono');
ns_render_page_start('tool:calculadora-ciclos-sono');
?>
<main>
  <div class="tool-page">
    <nav class="breadcrumb" aria-label="Navegação breadcrumb"><a href="<?= ns_escape(ns_href('/')) ?>">Início</a><span class="sep">›</span><a href="<?= ns_escape(ns_href('/ferramentas')) ?>">Ferramentas</a><span class="sep">›</span><span>Calculadora de Ciclos de Sono</span></nav>
    <div class="tool-header"><div class="tool-page-icon" style="background:linear-gradient(135deg,#eef4ff,#dbe7ff)">💚</div><div><h1>Calculadora de Ciclos de Sono</h1><p>Melhor horário para dormir/acordar com interface simples e resultado imediato.</p><span class="tag tag-green">Saúde</span></div></div>
    <div class="tool-box">
