...
ns_redirect_legacy_url('/ferramentas/removedor-pontuacao');
ns_render_page_start('tool:removedor-pontuacao');
?>
<main>
  <div class="tool-page">
    <nav class="breadcrumb" aria-label="Navegação breadcrumb"><a href="<?= ns_escape(ns_href('/')) ?>">Início</a><span class="sep">›</span><a href="<?= ns_escape(ns_href('/ferramentas')) ?>">Ferramentas</a><span class="sep">›</span><span>Removedor de Pontuação</span></nav>
    <div class="tool-header"><div class="tool-page-icon" style="background:linear-gradient(135deg,#eef4ff,#dbe7ff)">📝</div><div><h1>Removedor de Pontuação</h1><p>Remover pontuação com interface simples e resultado imediato.</p><span class="tag tag-green">Texto</span></div></div>
    <div class="tool-box">
