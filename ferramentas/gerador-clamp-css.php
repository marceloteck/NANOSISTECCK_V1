...
ns_redirect_legacy_url('/ferramentas/gerador-clamp-css');
ns_render_page_start('tool:gerador-clamp-css');
?>
<main>
  <div class="tool-page">
    <nav class="breadcrumb" aria-label="Navegação breadcrumb"><a href="<?= ns_escape(ns_href('/')) ?>">Início</a><span class="sep">›</span><a href="<?= ns_escape(ns_href('/ferramentas')) ?>">Ferramentas</a><span class="sep">›</span><span>Gerador de Clamp CSS</span></nav>
    <div class="tool-header"><div class="tool-page-icon" style="background:linear-gradient(135deg,#eef4ff,#dbe7ff)">🎨</div><div><h1>Gerador de Clamp CSS</h1><p>Tipografia responsiva com interface simples e resultado imediato.</p><span class="tag tag-green">Design</span></div></div>
    <div class="tool-box">
